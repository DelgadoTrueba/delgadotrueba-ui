...
<dt-button label="example" id="example-button--primary" />
...
<dt-button label="example" id="your-directory-button--primary"/>

### Secondary

<dt-button label="example" id="your-directory-button--secondary"/>

### Large

<dt-button label="example" id="your-directory-button--large"/>

### Small

<dt-button label="example" id="your-directory-button--small" />